...
class Card extends Component {
        ...
        return(
            <div className="col-lg-4 col-md-6 mb-4">
                    <div className="card h-100">
                        <Link to={cardData.INFO}><img className="card-img-top" src={cardData.IMGURI} alt="" /></Link>
                        <div className="card-body">
                            <h4 className="card-title">
                            <Link to={cardData.INFO}>{cardData.TITLE}</Link>
                            </h4>
                            <h5>${cardData.PR}</h5>
    ...
    render(){
        const {filterData,cardData} =  this.props;
        return filterData === null ? 
                this.loadDefaultData() : 
                    filterData === cardData.CAT ? 
                    this.loadDefaultData() : '';
            }
}
export default Card;